...
fetch("http://localhost:3000/api/products")
  ...
  .catch((err) => {
    let erreur = document.querySelector(".titles");
    let parentErreur = document.getElementById("err");
    // console.log(parentErreur);

    let newErr = document.createElement("h1");
    newErr.innerHTML = "error 404";

    parentErreur.replaceChild(newErr, erreur);
